<?php
/**
 * Block Pattern : cta/text-button.php
 *
 * @package simplifii
 */
?>
...
<div class="wp-block-group alignwide has-border-color has-recommended-color-02-border-color has-white-background-color has-background" style="border-style:solid; border-width:4px">
	...
	<p class="has-text-align-center">Eu per primis facilisis venenatis neque nisl integer, faucibus egestas rhoncus
		...
		neque commodo mollis facilisi, fermentum aenean hendrerit enim suspendisse molestie rutrum, phasellus quis nisi
		varius faucibus. Arcu curae hac nec sociosqu diam placerat luctus ultrices nisi libero vivamus, purus sem
		senectus porttitor phasellus venenatis fringilla condimentum tellus egestas, quisque lacinia erat curabitur
		parturient sapien donec ultricies natoque a.</p>
	<!-- /wp:paragraph -->
